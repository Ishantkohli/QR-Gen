...
const BrandLogos = {
  tiktok: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23000000"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298 0 .586.046.86.13V9.42a6.33 6.33 0 0 0-.86-.06 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.34-6.34V8.75a8.28 8.28 0 0 0 4.84 1.54V6.85a4.85 4.85 0 0 1-1.07-.16z"/></svg>',
  dropbox: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%230061FF"><path d="M6 2l6 3.86L6 9.72 0 5.86 6 2zm12 0l6 3.86-6 3.86-6-3.86L18 2zM0 13.58l6-3.86 6 3.86-6 3.86-6-3.86zm18-3.86l6 3.86-6 3.86-6-3.86 6-3.86zm-6 4.96l6 3.86-6 3.86-6-3.86 6-3.86z"/></svg>',
  maps: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23EA4335"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>',
  ...
  wikipedia: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23111827"><path d="M12.09 13.064L9.56 5.244H7.29L2.3 18.756h2.21l1.39-3.79h5.19l1.37 3.79h2.22l-2.59-5.692zm-5.46 0l2.05-5.6 2.05 5.6H6.63zm15.07 5.692l-4.99-13.512h-2.27l-2.53 7.82 2.53 5.692h2.21l1.37-3.79h5.19l1.39 3.79h2.1l-5-13.512z"/></svg>',
  twitch: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%239146FF"><path d="M2.149 0L.537 4.119v16.836h5.731V24h3.224l3.045-3.045h4.657l6.269-6.269V0H2.149zm19.164 13.612l-3.582 3.582H12l-3.045 3.045v-3.045H4.119V2.149h17.194v11.463zM16.478 5.731h-2.149v6.448h2.149V5.731zm-6.09 0H8.239v6.448h2.149V5.731z"/></svg>',
  pinterest: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23BD081C"><path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.162-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.72-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.024 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738a.36.36 0 0 1 .083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.631-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146 1.124.347 2.317.535 3.554.535 6.627 0 12.004-5.378 12.004-12.004C24.017 5.367 18.64 0 12.017 0z"/></svg>',
  ...
  messenger: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%230084FF"><path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.093.303 2.25.464 3.443.464 6.627 0 12-4.975 12-11.111C24 4.974 18.627 0 12 0zm1.191 14.963l-3.055-3.26-5.963 3.26 6.559-6.963 3.13 3.259 5.889-3.259-6.56 6.963z"/></svg>',
  ...
  tripadvisor: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%2300AF87"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-5 13c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm10 0c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"/></svg>',
  soundcloud: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23FF5500"><path d="M18.25 8.35C17.2 8.35 16.03 9 15.38 10c-2.3 0-4.26 1.4-5.06 3.42-.32-.1-.66-.16-1.02-.16-.3 0-.6.04-.88.13v5.5h10.9c2.08 0 3.76-1.68 3.76-3.76s-1.68-3.74-3.76-3.74z"/></svg>',
  ...
  telegram: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%2324A1DE"><path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm5.56 8.16l-1.97 9.28c-.15.65-.53.81-1.08.5l-3-2.21-1.45 1.39c-.16.16-.3.3-.61.3l.21-3.05 5.56-5.02c.24-.22-.05-.34-.38-.13l-6.87 4.33-2.96-.92c-.64-.2-.66-.64.13-.95l11.58-4.46c.54-.2 1.01.12.84.94z"/></svg>',
  wechat: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%2307C160"><path d="M8.691 2.188C3.891 2.188 0 5.478 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.294.295a.34.34 0 0 0 .17-.05l1.94-1.12c.16-.094.354-.11.53-.053.94.267 1.94.41 2.98.41.31 0 .61-.01.91-.04a6.76 6.76 0 0 1-.36-2.18c0-3.66 3.42-6.63 7.64-6.63.36 0 .72.02 1.07.07C17.001 5.92 13.16 2.188 8.69 2.188zm-2.45 4.09c.67 0 1.22.55 1.22 1.23s-.55 1.22-1.22 1.22c-.68 0-1.23-.54-1.23-1.22s.55-1.23 1.23-1.23zm4.91 0c.67 0 1.22.55 1.22 1.23s-.55 1.22-1.22 1.22c-.68 0-1.23-.54-1.23-1.22s.55-1.23 1.23-1.23zm5.72 4.91c-3.66 0-6.63 2.53-6.63 5.66 0 1.72.9 3.26 2.32 4.31a.46.46 0 0 1 .17.51l-.31 1.15c-.01.05-.03.11-.03.17 0 .13.1.23.23.23a.27.27 0 0 0 .13-.04l1.51-.87c.13-.07.28-.09.42-.04.73.21 1.51.32 2.32.32 3.66 0 6.63-2.54 6.63-5.67s-2.97-5.67-6.63-5.67zm-1.9 3.19c.52 0 .95.43.95.96s-.43.95-.95.95-.96-.42-.96-.95.43-.96.96-.96zm3.8 0c.53 0 .96.43.96.96s-.43.95-.96.95-.95-.42-.95-.95.42-.96.95-.96z"/></svg>',
  ...
  android: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%233DDC84"><path d="M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.551 0 .9993.4482.9993.9993.0001.5511-.4482.9997-.9993.9997m-11.046 0c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993 0 .5511-.4482.9997-.9993.9997m11.4045-6.02l1.9973-3.4592a.416.416 0 00-.1521-.5676.416.416 0 00-.5676.1521l-2.0223 3.503C15.5902 8.4111 13.8533 8.0805 12 8.0805s-3.5902.3306-5.1367.8692L4.841 5.4467a.4161.4161 0 00-.5677-.1521.4157.4157 0 00-.1521.5676l1.9973 3.4592C2.6889 11.1867.3432 14.6589 0 18.761h24c-.3432-4.1021-2.6889-7.5743-6.1185-9.4396"/></svg>',
  audio: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%230284c7"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07" stroke="%230284c7" stroke-width="2" fill="none"/></svg>',
  contact: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23e11d48"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',
...
class App {
  ...
  renderDesignPresetsModal(filterCategory = 'all') {
      ...
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          ...
          if (miniDiv && !card.dataset.rendered) {
            ...
            const logoImg = presetData.image || (presetData.logoBrand && BrandLogos[presetData.logoBrand] ? BrandLogos[presetData.logoBrand] : '');
            const miniQR = new QRCodeStyling({
              ...
              backgroundOptions: { color: presetData.background || '#ffffff' },
    ...
    filtered.forEach(preset => {
      ...
      if (preset.frame && preset.frame !== 'none') {
        thumb.style.borderColor = preset.frameColor || 'var(--primary)';
      }
  ...
  applyPreset(preset) {
    ...
    // Logo handling
    const brandGrid = document.getElementById('brandPresetsGrid');
    if (brandGrid) {
      brandGrid.querySelectorAll('.logo-preset-btn').forEach(b => b.classList.remove('active'));
    }
    ...
    if (preset.frameText !== undefined) document.getElementById('frameTextInput').value = preset.frameText;
